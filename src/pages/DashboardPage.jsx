...
export default function Dashboard() {
  ...
  const loadEquipmentAlerts = useCallback(async (companyId) => {
    if (!companyId) return;
        ...
        <Card>
          <div className="wi-card__titleRow">
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <Button onClick={loadCompanies} disabled={loadingCompanies}>Reload</Button>
              <Button onClick={resetCompanySelection} disabled={loadingCompanies}>Reset</Button>
            </div>
          </div>
